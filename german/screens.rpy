...
translate german strings:
    ...
    new "{size=-8}Freeport Space Station 2 erstellt von {a=https://sketchfab.com/dradnon}Inditrion Dradnon{/a}, Lizenz: {a=https://creativecommons.org/licenses/by/4.0/}CC BY 4.0{/a}"
