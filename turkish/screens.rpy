...
translate turkish strings:
    ...
    new "v[config.version] • Taboo Sürümü, Ekstra Sahneler"


    old "v[config.version] • Standard Edition, Extra Scenes"
    new "v[config.version] • Standart Sürüm, Ekstra Sahneler"


    old "v[config.version] • Taboo Edition"
    new "v[config.version] • Taboo Sürümü"


    old "v[config.version] • Standard Edition"
    new "v[config.version] • Standart Sürüm"


    old "Support me on  Patreon:\nwww.patreon.com/perverteer"
    new "Patreon'da beni destekleyin:\nwww.patreon.com/perverteer"
    ...
    new "Diyalog atlama özelliğini açar/kapatır."
